...
class AlterToClientTypeClientsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('clients', function (Blueprint $table) {
            ...
            $enum = implode(',',$maritalStatusString);
            \DB::statement("ALTER TABLE clients CHANGE COLUMN marital_status marital_status ENUM($enum) NULL");
    ...
    public function down()
    {
        Schema::table('clients', function (Blueprint $table) {
            ...
            $enum = implode(',',$maritalStatusString);
            \DB::statement("ALTER TABLE clients CHANGE COLUMN marital_status marital_status ENUM($enum) NOT NULL");
